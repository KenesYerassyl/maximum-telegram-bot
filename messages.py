...
"""
CHOOSE_TEST_MESSAGE = "Тест нәтижесін білу үшін өз нұсқаңызды таңдаңыз⬇️"
SHOW_TEST_MESSAGE = "Тест нәтижесін көрсету"
...
MAIN_KEYBOARD_SET = [NEW_ID_MESSAGE, SHOW_TEST_MESSAGE, SCHEDULE_MESSAGE, ATTENDANCE_MESSAGE, REVIEW_MESSAGE]
BOT_FAILURE_MESSAGE = "Бот жұмысында қате кетті. Басынан тырысып көріңіз!"
BACK_MESSAGE = "Кері қайту"
SERVICE_RECOMMENDATION_MESSAGE = "Қызмет тоқтатылды. Сізге тағы қалай көмектесе аламын?"
...
def id_succes_code(id):
    return f"💡Сіздің ИИН номеріңіз табылды: ***{id}***"
