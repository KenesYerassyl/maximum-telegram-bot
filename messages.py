...
NO_USER_ID = f"Бот қызметін толық қолдану үшін өз ИИН номеріңізді жазыңыз. ИИН номеріңізді жіберу үшін, ***{NEW_ID_MESSAGE}*** батырмасын басыңыз."
NOT_SUBSCRIBED = "Бот қызметін толық қолдану үшін өз ИИН номеріңізді жазыңыз."
SCHEDULE = "Сабақ кестесін көру"
