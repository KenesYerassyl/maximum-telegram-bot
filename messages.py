...
NO_USER_ID = "Бот қызметін толық қолдану үшін өз ИИН номеріңізді жазыңыз."
NOT_SUBSCRIBED = "Бот қызметін толық қолдану үшін өз ИИН номеріңізді жазыңыз. ИИН номеріңізді жіберу үшін, ***{NEW_ID_MESSAGE}*** батырмасын басыңыз."
